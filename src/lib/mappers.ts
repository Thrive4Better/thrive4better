...
export function toCarer(row: any): Carer {
  return {
    ...
    age: row.date_of_birth
      ? Math.floor((Date.now() - new Date(row.date_of_birth).getTime()) / 31557600000)
      : undefined,
    address: row.address ?? undefined,
    suburb: row.suburb ?? undefined,
    postcode: row.postcode ?? undefined,
    state: row.state ?? undefined,
    tfn: row.tfn ?? undefined,
    ...
    superFundName: row.super_fund_name ?? undefined,
    superMemberNumber: row.super_member_number ?? undefined,
...
export function fromCarer(
  ...
  return omitUndefined({
    ...
    tfn: entity.tfn,
    abn: entity.abn,
    bank_account_name: entity.bankAccountName,
    bank_bsb: entity.bankBsb,
    bank_account_number: entity.bankAccountNumber,
    super_fund_name: entity.superFundName,
    super_member_number: entity.superMemberNumber,
    emergency_contact_name: entity.emergencyContactName,
    emergency_contact_phone: entity.emergencyContactPhone,
    emergency_contact_relation: entity.emergencyContactRelation,
    hire_date: entity.hireDate,
    hourly_rate: entity.hourlyRate,
    tier: entity.tier,
    preferred_clients: entity.preferredClients,
    max_weekly_hours: entity.maxWeeklyHours,
    drivers_license: entity.driversLicense,
    own_vehicle: entity.ownVehicle,
...
export function toSessionNote(row: any): SessionNote {
  return {
    ...
    supportWorker: row.support_worker ?? '',
    startTime: row.start_time ?? '',
    finishTime: row.finish_time ?? '',
    activityCompleted: row.activity_completed ?? '',
    content: row.content ?? '',
    participantMood: row.participant_mood ?? 'neutral',
    supportProvided: row.support_provided ?? '',
    incidentsOrConcerns: row.incidents_or_concerns ?? '',
    transportKms: row.transport_kms ?? 0,
...
export function fromSessionNote(
  ...
  return omitUndefined({
    ...
    shift_id: entity.shiftId || undefined,
    carer_id: entity.carerId || undefined,
    client_id: entity.clientId,
    date: entity.date || undefined,
    support_worker: entity.supportWorker || undefined,
    start_time: entity.startTime || undefined,
    finish_time: entity.finishTime || undefined,
    activity_completed: entity.activityCompleted || undefined,
    content: entity.content || undefined,
    participant_mood: entity.participantMood,
    support_provided: entity.supportProvided || undefined,
    incidents_or_concerns: entity.incidentsOrConcerns || undefined,
    transport_kms: entity.transportKms ?? 0,
    additional_observations: entity.additionalObservations || undefined,
    goals_addressed: entity.goalsAddressed,
    follow_up_required: entity.followUpRequired,
    follow_up_notes: entity.followUpNotes || undefined,
    invoice_id: entity.invoiceId || undefined,
    ai_summary: entity.aiSummary || undefined,
  });
}
